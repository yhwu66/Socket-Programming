...
#define MYPORT "22483" // the port users will be connecting to
...
int main(void)
{
	...
	FILE *fp1;
	fp1 = fopen("block2.txt", "r");
	FILE *fp1_tmp;
	;
	fp1_tmp = fopen("block2_tmp.txt", "w");
	char *line_buf = NULL;
	...
	fclose(fp1_tmp);
	remove("block2.txt");
    rename("block2_tmp.txt", "block2.txt");
